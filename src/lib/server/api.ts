...
export function blockWriteInDemoMode(context: ApiRequestContext) {
  ...
  return withRequestId(
    NextResponse.json(
      {
        error: "A demonstração pública é somente leitura.",
        code: "READ_ONLY_DEMO",
...
export function hideInteractiveDataInDemoMode() {
  return getAppConfig().appMode === "demo"
